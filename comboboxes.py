...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboX.setGeometry(QtCore.QRect(40, 60, 261, 171))
        font = QtGui.QFont()
        ...
        self.comboY.setGeometry(QtCore.QRect(500, 60, 261, 171))
        font = QtGui.QFont()
        font.setPointSize(28)
        ...
        self.submit.setGeometry(QtCore.QRect(280, 420, 221, 71))
        font = QtGui.QFont()
        font.setPointSize(22)
        self.submit.setFont(font)
        self.submit.setObjectName("submit")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(280, 290, 231, 81))
        font = QtGui.QFont()
        font.setPointSize(22)
        font.setBold(True)
        font.setWeight(75)
        ...
        # self.comboX.addItem("Hello")  # Quick way to add element inside combobox
        # index = self.comboX.findText('Hello', QtCore.Qt.MatchFixedString)  # find element(index) in combo box
